...
class PoliceMainScreen extends StatefulWidget {
  const PoliceMainScreen({super.key});

  @override
  State<PoliceMainScreen> createState() => _PoliceMainScreenState();
}
...
class _PoliceMainScreenState extends State<PoliceMainScreen> {
  ...
  TextStyle BadgeNo = const TextStyle(
    color: Colors.white,
    fontSize: 12,
    fontFamily: 'Barlow',
  ...
  TextStyle BadgenoText = const TextStyle(
    color: Color(0xFFE22128),  // You can replace this with the desired color
    fontSize: 12,
    fontFamily: 'Barlow',
    fontWeight: FontWeight.w700,
    height: 1.2,
                              ...
                              children: [
                                ...
                                RichText(
                                  text: TextSpan(children: [
                                    TextSpan(text: 'Badge No : ', style: BadgenoText),
                                    TextSpan(text: 'Ad1122 ', style: BadgeNo),
                                  ]),
                                ),
                              ],
                            ),
